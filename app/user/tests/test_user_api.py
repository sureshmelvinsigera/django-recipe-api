...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        ...
        payload = {"email": "test@test.com", "password": "test123", "name": "Test name"}
    ...
    def test_password_too_short(self):
        """Test that the passworrd must be more than 5 characters"""
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        self.user = create_user(
            email="test@test.com", password="testpassword1234", name="testuser"
        )
        self.client = APIClient()
